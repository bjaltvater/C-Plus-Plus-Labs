...
{ 
   ...
   public: 
	  ...
	  friend void modifyGoal(double, SalesForce &);
};
...
void modifyGoal(double, SalesForce &);
...
void modifyGoal(double amtRaise, SalesForce & rep)
{
	rep.salesGoal += amtRaise;
